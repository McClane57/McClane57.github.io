...
window.ESSAYS = [
  ...
  },
  {
    ...
    body: [
      ...
      { k: 'p', t: 'The specialists measured well in my own harness. But the model\'s job here is deliberately narrow: it phrases what the engine already decided, and it never produces a number. Across that narrow job the gap did not show up anywhere a user would feel it — it lived in my eval, not in the app. What it would have cost was real either way: two more downloads, two more runtimes to keep aligned with the harness, two more things to re-verify every time the prompt format moved.' },
