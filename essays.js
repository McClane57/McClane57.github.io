...
window.ESSAYS = [
  ...
  },
  {
    ...
    body: [
      ...
      { k: 'p', t: 'The periodization engine exists. Sixteen weeks, a class × weight-category matrix, peak volume from it, demographic corrections on top. Deterministic, offline, tests green. The rules catalogue exists — nineteen rules, stable IDs, each described.' },
